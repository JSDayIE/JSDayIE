    ...
    return (
      <Container>
        <Section title="Welcome to JSdayIE 2023!" size={1}>
            <p>
              JSDayIE 2013 is a 1-day single track tech conference dedicated to
              the JavaScript community in Ireland featuring 500 attendees and
            ...
            <p>
              ...
              2nd edition of JSDayIE will take place on September 26th 2023 at 
