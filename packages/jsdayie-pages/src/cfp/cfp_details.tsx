        ...
        <Section title="Call for proposals" size={1}>
          ...
          <Section title="Topics" size={2}>
            <p>
                ...
                community in Ireland. We are looking for a multitude of topics and perspectives but most
                of all we value:
            </p>
            <Table
                headers={[
            ...
            />
            <p>
              We don't have a specific theme for JSDayIE. Instead, we’re aiming to select talks that are
              interesting to as many JavaScript developers as possible. Our audience skill level is
              intermediate to advanced.
            </p>
            <p>
              All talks should be in English and 25 minutes long. We will be on a tight schedule
              and will enforce the time limits rigorously. We suggest that you time your presentation
          ...
          <Section title="Selection process" size={2}>
            ...
            <p>
              Each member of the commitee will go through the proposals and will create their own shortlist.
              Based on the recurrence of a proposal on multiple shortlists we will proceed to place it on
              the final list. All the speakers will get a response, positive or negative.
            </p>
            <p>
              We will do our best to build an agenda that covers diverse topics which can be of interest
              for the majority of attendees interested in the current landscape of the JavaScript world.
            </p>
          </Section>
          ...
          <Section title="We can help" size={2}>
            <p>
              Not everyone is a natural-born talent on stage. Not everyone can produce kick-ass slide decks.
              Not everyone is a live-demo master. Not everyone knows they have something great to talk about.
            </p>
            <p>
              There are about a million reasons why you may not consider yourself a speaker. We are here to prove you wrong.
              If all you have is a gut feeling that you should be on stage, we are here to help you develop or hone the skills
              you think you lack to deliver a great presentation.
            </p>
            <p>
          ...
          <Section title="Video Recordings" size={2}>
              <p>
                We plan to record and publish all talks
                in <a target="_blank" href="https://www.youtube.com/channel/UCUPILOYOw8pbBWuKEaqI1EQ">our youtube channel</a> for 
                free, along with a recording of the slide deck, live demo, and any
                on-presenter-screen activity. We do this for the benefit of the larger JavaScript
                community and those who couldn’t make it to the conference. We hope you agree with
                us, but if you are uncomfortable with this in any way, let us know and we will
                work things out. Note that we disabled comments on our published videos by default.
              </p>
              <p>
                Finally, since you retain full ownership of your slides and recording, we’d like
                to ask you to make your materials and recording available under a Creative Commons
                (we default to non-commercial reuse) or other open source license.
              </p>
          </Section>
