  ...
  return (
    <Container>
      <Section title="The first JavaScript conference in Ireland is back!" size={1}>
        ...
        <p>
          JSDayIE was the first JavaScript conference in Ireland in 2019. 
          After the COVID pandemic. The 2nd edition of JSDayIE will take place 
          on September 26th 2023 at The Round Room at the Mansion House in 
