        ...
        <>
          <Section title="Would you like to sponsor JSdayIE 2023?" size={1}>
            <p>
              ...
              growth of the JavaScript community in Ireland. Please join us in
              creating an amazing experience for each and every attendee.
            </p>
            <Table
              headers={[
                "",
            ...
            <p>
              We also offer the following additional sponsorship opportunities:
            </p>
            <Table
              headers={[
                "",
            ...
            <p>* Fees are displayed excluding 23% VAT</p>
            <p>
              Sponsoring offers a unique opportunity to expose your brand and
              find talent specialized in JavaScript technologies in Ireland.
            </p>
            <br />
        ...
        <Section title="A shout out to our 2023 sponsors!" size={1}>
          ...
          {!displayPackages ? (
            <>
              <br />
              <Button
                href="https://bit.ly/SponsorJSDayIE2023Now"
                color="warning"
              >
                Download our prospectus
              </Button>
